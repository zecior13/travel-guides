...
const PLACE_EXTRAS = {
  ...
  "brooklyn-tabernacle":{region:"brooklyn",status:"w planie · 23.08 · 09:00",why:"Poranne nabożeństwo pozwala doświadczyć gospel bez skracania wizyty w Guggenheimie.",curiosity:"Brooklyn Tabernacle jest wielokulturową wspólnotą znaną z chóru gospel i oficjalnie zaprasza gości na niedzielne nabożeństwa.",photoTip:"Zdjęcie zróbcie wyłącznie na zewnątrz; podczas nabożeństwa telefony pozostają schowane.",nearby:["guggenheim"]},
...
const DAY_SCHEMATICS = {
  ...
  "2026-08-23": { note: "Gospel na Brooklynie prowadzi do pełnej wizyty w Guggenheimie, historycznego Village i wieczoru z Hiromi.", nodes: [["Hotel", "midtown", "⌂", "overview"], ["Brooklyn Tabernacle", "brooklyn", "♫", "gospel"], ["Guggenheim", "museum", "◌", "guggenheim"], ["Washington Sq.", "village", "●", "route"], ["Blue Note", "village", "♪", "bluenote"], ["M Social", "midtown", "☾", "rooftop"]], legs: ["metro ok. 30–35 min", "metro 4/5 + spacer 45–55 min", "metro/taxi 35–45 min", "spacer historyczny", "taxi/metro ok. 25–35 min"] },
...
const DAY_VISUALS = {
  ...
  "2026-08-23": { area:"Brooklyn → Museum Mile → Village", icon:"♫", event:"Gospel · Guggenheim · Hiromi", color:"#a94f3d" },
...
const VILLAGE_MAP_STOPS = [
  { panel:"overview", title:"Hotel", note:"08:10 · wyjazd na Brooklyn", left:43, top:43, icon:"H" },
  { panel:"gospel", title:"Brooklyn Tabernacle", note:"09:00 · poranne gospel", left:24, top:93, icon:"♫" },
...
function renderMetroPreparePanel() {
  const legs = [
    {line:"2/3",color:"#ee352e",title:"23.08 · hotel → Brooklyn Tabernacle",text:"2 lub 3 z Times Sq–42 St do Borough Hall; dalej około 8–10 minut pieszo do 17 Smith Street. Wyjazd 08:10."},
    {line:"4/5",color:"#00933c",title:"23.08 · Brooklyn Tabernacle → Guggenheim",text:"Po wyjściu najpóźniej 10:25: 4 lub 5 z Borough Hall do 86 St/Lexington Av; dalej około 12–15 minut pieszo do muzeum."},
