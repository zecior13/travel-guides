...
const DAYS = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: "15:10–16:40", title: "Historyczny spacer po Village", note: "Washington Square, MacDougal, Jefferson/Commerce i Stonewall; bez Carrie, Magnolii i Friends.", type: "plan" },
      { time: "16:40–17:10", title: "Caffè Reggio", note: "Cappuccino, zabytkowy ekspres i krótki reset; o 17:10 wychodzicie do Blue Note.", type: "plan" },
...
const DAY_GUIDES = {
  ...
  "2026-08-23": {
    ...
    gospel: {
      ...
      mapUrl: "https://www.google.com/maps/dir/?api=1&origin=Holiday+Inn+New+York+City+Times+Square,+585+8th+Ave,+New+York&destination=Brooklyn+Tabernacle,+17+Smith+St,+Brooklyn,+NY&travelmode=transit",
      onwardUrl: "https://www.google.com/maps/dir/?api=1&origin=Brooklyn+Tabernacle,+17+Smith+St,+Brooklyn,+NY&destination=Solomon+R.+Guggenheim+Museum,+1071+5th+Ave,+New+York&travelmode=transit"
    },
    route: [
      { time: "15:10", title: "Washington Square, NYU i MacDougal", text: "Łuk, park, kampus wpisany w miasto oraz dawna scena folkowa i komediowa. To pierwsza warstwa Village: studenci, artyści i życie uliczne.", look: "Łuk, fontanna, One Fifth Avenue i schody klubów na MacDougal Street.", pause: "Zatrzymajcie się na około 5 minut i obserwujcie muzyków, szachistów, studentów NYU oraz życie wokół fontanny.", image: { src: "assets/photos/127.jpg", alt: "Washington Square Arch, fontanna i życie parku", credit: "zdjęcie orientacyjne" }, related: [{ panel: "stories", key: "story-0", label: "Historia placu" }, { panel: "stories", key: "story-1", label: "Moses i Jane Jacobs" }, { panel: "stories", key: "story-4", label: "Historia muzyczna" }] },
      { time: "15:50", title: "Jefferson Market i Commerce Street", text: "Dawny gmach sądu z charakterystyczną wieżą, niewielki ogród oraz kręte ulice zachodniej części Village.", look: "Czerwona cegła, wieża Jefferson Market Library, brownstones i nietypowy łuk Commerce Street.", image: { src: "assets/photos/128.jpg", alt: "Ceglana bryła i wieża zegarowa Jefferson Market Library", credit: "zdjęcie orientacyjne" }, related: [{ panel: "stories", key: "story-3", label: "Dlaczego ulice się plączą?" }] },
      { time: "16:15", title: "Christopher Park i Stonewall", text: "Najważniejszy historyczny przystanek: park, rzeźby Gay Liberation, nadal działający Stonewall Inn oraz Visitor Center.", look: "Białe figury George’a Segala i mała skala miejsca w porównaniu z jego globalnym znaczeniem.", image: { src: "assets/photos/129.jpg", alt: "Białe rzeźby Gay Liberation w Christopher Park", credit: "zdjęcie orientacyjne" }, related: [{ panel: "stories", key: "story-2", label: "Historia Stonewall" }] },
      { time: "16:40–17:10", title: "Caffè Reggio", text: "Stały przystanek dnia: cappuccino w kawiarni działającej od 1927 roku. W środku znajduje się ozdobny ekspres z 1902 roku, renesansowe dzieła i ława związana z rodziną Medyceuszy.", look: "Zielona fasada, napis Original Cappuccino i zabytkowy ekspres wewnątrz. O 17:05 prosicie o rachunek; o 17:10 wychodzicie do Blue Note.", image: { src: "assets/photos/131.webp", alt: "Zielona fasada Caffè Reggio przy MacDougal Street", credit: "zdjęcie orientacyjne" }, related: [{ panel: "food", label: "Caffè Reggio i menu" }] }
    ],
    stories: [
    ...
    links: [
      ...
      { label: "Historyczny spacer w Mapach", url: "https://www.google.com/maps/dir/?api=1&origin=Washington+Square+Arch,+New+York&destination=Blue+Note+Jazz+Club,+131+W+3rd+St,+New+York&waypoints=MacDougal+Street,+New+York%7CJefferson+Market+Library,+New+York%7CCommerce+Street,+New+York%7CStonewall+National+Monument,+New+York%7CCaffe+Reggio,+119+MacDougal+St,+New+York&travelmode=walking" },
      ...
      { label: "Brooklyn Tabernacle · informacje dla gości", url: "https://www.brooklyntabernacle.org/bt-join-us/" },
...
const PLACES = [
  ...
  { id:"guggenheim", title:"Guggenheim od środka", icon:"◌", category:"sztuka", text:"Rotunda Wrighta i pełna 2,5-godzinna trasa Radka i Gosi przed Village.", meta:"23.08 · 11:30–14:00", dayId:"2026-08-23", panel:"guggenheim", map:"https://www.google.com/maps/search/?api=1&query=Solomon+R+Guggenheim+Museum" }
];
